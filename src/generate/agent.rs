...
//! use agentmap documentation, ensuring consistent and optimal behavior.
...
fn generate_stale_guidance(output: &mut String) {
    ...
    output.push_str("   ```bash\n");
    output.push_str("   agentmap --diff main\n");
    output.push_str("   ```\n\n");
    output.push_str("3. **Check freshness status:**\n");
    output.push_str("   ```bash\n");
    output.push_str("   agentmap --check\n");
    output.push_str("   ```\n\n");
    output.push_str("4. **Force full regeneration** (ignore cache):\n");
    output.push_str("   ```bash\n");
    output.push_str("   agentmap --force\n");
    output.push_str("   ```\n\n");
}
...
mod tests {
    ...
    fn test_generate_agent_md_basic() {
        ...
        assert!(result.contains("agentmap"));
    }
    ...
    fn test_stale_guidance_contains_commands() {
        ...
        assert!(output.contains("agentmap"));
        assert!(output.contains("agentmap --diff main"));
        assert!(output.contains("agentmap --check"));
        assert!(output.contains("agentmap --force"));
    }
}
